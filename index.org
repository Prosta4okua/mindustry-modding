#+TITLE: Руководство Mindustry по созданию модификаций
:PREAMBLE:
...
#+TEXINFO_HEADER: Документация для Mindustry. Версия 100 (81)

Оставляйте pull requests, сообщения об ошибках или предложееия на Github: https://github.com/SimonWoodburyForget/mindustry-modding
...
* Overview
  ...
  Модификации Mindustry - это просто каталоги ресурсов. Вы повторно используете существующие типы и можете использовать различные значения для их инициализации, также вы можете перезаписать инициализацию стандартных ресурсов.

  Вы можете добавлять свои спрайты и звуки; поделиться своим модом так же просто, как дать кому-то свой каталог проектов; также модификации работают между разными платформами, которые поддерживают эти модификации.
...
** Directory Structure
   ...
   Ваша директория проекта должны выглядеть таким образом:
   ...
   Каждая платформа имеет свой каталог данных пользовательских приложений, и именно в нём ваши моды должны быть размещены:
   * Linux: =~/.local/share/Mindustry/mods/=
   * Steam: =steam/steamapps/common/Mindustry/mods/=
   * Windows: =%appdata%/Mindustry/mods/=

   *Заметка;* слова в названиях Ваших файлов должны быть записаны в нижнем регистре и разделены дефисами:
